...
public interface RecuperacaoSenhaRepository extends JpaRepository<RecuperacaoSenha, String> {
    ...
    @Query(value = "SELECT COUNT(1) FROM recuperacao_senha AS rs INNER JOIN usuario AS us ON us.email_usuario = ?1", nativeQuery = true)
	public Integer findEmailExist(String email);
	...
	public Integer findEmailEnderecoExist(String email, String endereco);
}
